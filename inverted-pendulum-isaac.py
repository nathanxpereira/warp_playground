...
class InvertedPendulum(BaseTask):
    ...
    def set_up_scene(self, scene) -> None:
        ...
        # Clone the entire pendulum system for multi-env
        prim_paths = self._cloner.generate_paths("/World/pendulum_system", self._num_envs)
        self._cloner.clone(
    ...
    def set_object(self):
        # Create parent XForm using USD stage directly
        ...
        # Create all components under the parent
        ...
        self.cart = DynamicCuboid(
            ...
            size=1.0,
            scale=np.array([self.cart_width, self.cart_depth, self.cart_height]),
            mass=None,
            density=1000.0,
    ...
    def _create_joints(self):
        ...
        for i in range(self._num_envs):
            ...
            # Prismatic joint for cart on track
            ...
            # Revolute joint between cart and pendulum
            ...
            joint.CreateLocalPos0Attr().Set(Gf.Vec3f(0.0, 0.0, self.cart_height/2))
            joint.CreateLocalPos1Attr().Set(Gf.Vec3f(0.0, 0.0, -self.pendulum_length/2))
